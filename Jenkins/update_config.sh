...
yq e -i ".vpc.subnets.public.\"eu-west-3a\".id = \"${public_subnet_id}\"" cluster.yaml
yq e -i ".vpc.subnets.private.\"eu-west-3a\".id = \"${private_subnet_1_id}\"" cluster.yaml
yq e -i ".vpc.subnets.private.\"eu-west-3b\".id = \"${private_subnet_2_id}\"" cluster.yaml
